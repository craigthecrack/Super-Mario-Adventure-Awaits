...
# By Kamek64, MalStar1000, RoadrunnerWMC, Ryguy
...
class SpriteImage_CameraScrollLimiter(SLib.SpriteImage_StaticMultiple):  # 538
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (0, 0)
...
class SpriteImage_Tenten(SLib.SpriteImage_StaticMultiple):  # 541
    def __init__(self, parent):
        super().__init__(parent)
...
class SpriteImage_TentenWing(SLib.SpriteImage_StaticMultiple):  # 542
    def __init__(self, parent):
        super().__init__(parent)
...
ImageClasses = {
    ...
    541: SpriteImage_Tenten,
    542: SpriteImage_TentenWing,
}
